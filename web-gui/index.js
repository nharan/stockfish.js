document.addEventListener("DOMContentLoaded", function() {
    ...
    function engineGame(options) {
        options = options || {};
        let engine = typeof STOCKFISH === "function" ? STOCKFISH() : new Worker(options.stockfishjs || './engine/stockfish17/stockfish-17-lite-single.js');
        let evaler = typeof STOCKFISH === "function" ? STOCKFISH() : new Worker(options.stockfishjs || './engine/stockfish17/stockfish-17-lite-single.js');
        let engineStatus = {};
